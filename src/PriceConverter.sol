...
library PriceConverter {
    ...
    function getConversionRateEthToUsd(uint256 _ethAmount, AggregatorV3Interface _priceFeed)
        public
        view
        returns (uint256)
    {
    ...
    function getConversionRateUsdToEth(uint256 _usdAmount, AggregatorV3Interface _priceFeed)
        public
        view
        returns (uint256)
    {
        ...
        uint256 usdToEth = (_usdAmount * 1e18) / ethPrice;
        return usdToEth;
    }
}
